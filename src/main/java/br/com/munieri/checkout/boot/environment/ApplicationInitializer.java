package br.com.munieri.checkout.boot.environment;
...
@EnableJpaRepositories({"br.com.munieri.checkout.infrastructure.repository"})
@EnableWebMvc
public class ApplicationInitializer {

    private static final Logger LOGGER = LogManager.getLogger();
    private static final String PACKAGES = "br.com.munieri.checkout.infrastructure.repository";
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "br.com.munieri.checkout" });
